...
// ---------------------------------------------------------
			...
			$background_defaults = array(
				'color' => '#ecede9',
				'image' => ''.CHILD_URL.'/images/main_bg.png',
				'repeat' => 'repeat',
				'position' => 'top center',
				'attachment'=>'scroll'
			);
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '22px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#787476'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '48px', 'lineheight' => '50px', 'face' => 'Pacifico', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2d2b2c'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '34px', 'lineheight' => '50px', 'face' => 'Pacifico', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2d2b2c'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '30px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2d2b2c'));
			...
			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '40px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2d2b2c'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '24px', 'lineheight' => '50px', 'face' => 'Pacifico', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2d2b2c'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '10px', 'lineheight' => '16px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2d2b2c'));
