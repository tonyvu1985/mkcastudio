...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function My_SocialNetworksWidget() {
		...
		$this->__construct('social_networks', __('Cherry - Social Networks', CURRENT_THEME), $widget_ops);
	}
	...
	function widget( $args, $instance ) {
		...
		<?php foreach(array("Twitter", "Facebook", "Flickr", "Feed", "Linkedin", "Delicious", "Youtube", "Google", "Pinterest") as $network) : ?>
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'twitter' => '', 'twitter_label' => '', 'facebook' => '', 'facebook_label' => '', 'flickr' => '', 'flickr_label' => '', 'feed' => '', 'feed_label' => '', 'linkedin' => '', 'linkedin_label' => '', 'delicious' => '', 'delicious_label' => '', 'youtube' => '', 'youtube_label' => '', 'google' => '', 'google_label' => '', 'pinterest' => '', 'pinterest_label' => '', 'display' => 'icons', 'text' => '');
